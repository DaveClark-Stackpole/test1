...
def email_manual1(tmp,reason):
    ...
    message = ""
    toaddrs = ["jmcmaster@stackpole.com","dmiller@stackpole.com","dclark@stackpole.com","sherman@stackpole.com","pmurphy@stackpole.com","ghundt@stackpole.com","kfrey@stackpole.com","asmith@stackpole.com","smcmahon@stackpole.com","mclarke@stackpole.com","gharvey@stackpole.com","rstanley@stackpole.com","nkleingeltink@stackpole.com"]
